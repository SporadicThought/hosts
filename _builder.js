...
(function(index){                                              //HOSTS content-fix.
  ...
  var REGEX_INVALID_HOSTS_BAD_ASCII   = /^.*[^a-z\d\-\_\.\n]+.*$/igm   //not allowed Unicode/UTF-8 letters.
     ...
     ,REGEX_DONTCARE_HOSTS1           = /^(support|discuss|forum|blog|chat|doc|wiki|guide|help|communit).{0,3}\..+/igm  //community, communities, blog, blogs, doc, docs - any support/documents/wiki subdomain can be indicate a safe domain, which can be removed. there is a 'free' possible-suffix of up to 2 characters (forum/forums/blog/blogs/blogs2/..).
     ,REGEX_DONTCARE_HOSTS2           = /^(kb)\..+/igm  //kb pages (help).
